...
import org.apache.doris.nereids.trees.expressions.functions.agg.CollectArray;
...
import org.apache.doris.nereids.trees.expressions.functions.agg.MapSum;
...
public class BuiltinAggregateFunctions implements FunctionHelper {
    public final List<AggregateFunc> aggregateFunctions = ImmutableList.of(
            ...
            agg(CollectArray.class, "agg_array_collect_set", "groupUniqArrayArray"),
            agg(Corr.class, "corr"),
